...
function analyzeHTMLCoverage(html) {
    const elements = {
        ...
        'Semantic main': /<main[\s>]/i.test(html),
        'Semantic section': /<section[\s>]/i.test(html),
        'Semantic footer': /<footer[\s>]/i.test(html),
        'Form element': /<form[\s>]/i.test(html),
        'Input element': /<input[\s>]/i.test(html),
        'Button element': /<button[\s>]/i.test(html),
        'Canvas element': /<canvas[\s>]/i.test(html),
        'Script element': /<script[\s>]/i.test(html),
        'Style element': /<style[\s>]/i.test(html),
        'Label element': /<label[\s>]/i.test(html),
